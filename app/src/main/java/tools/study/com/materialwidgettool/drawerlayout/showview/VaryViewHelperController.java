 ...
 */
package tools.study.com.materialwidgettool.drawerlayout.showview;
...
public class VaryViewHelperController {
    ...
    public void showNetworkError(View.OnClickListener onClickListener) {
        View layout = helper.inflate(R.layout.showview_message);
    ...
    public void showEmpty(String emptyMsg, View.OnClickListener onClickListener) {
        View layout = helper.inflate(R.layout.showview_message);
        TextView textView = (TextView) layout.findViewById(R.id.message_info);
        if (!Strings.isNullOrEmpty(emptyMsg)) {
    ...
    public void showLoading(String msg) {
        View layout = helper.inflate(R.layout.showview_loading);

...
public class RevealActivity extends BaseDetailActivity implements View.OnTouchListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DrawableCompat.setTint(shared_target.getDrawable(), ContextCompat.getColor(this, sample.getColor()));
    ...
    private void setupLayout() {
        ...
        toolbar = (Toolbar) findViewById(R.id.material_animation_toolbar);
